...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/strawberryfields-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14738&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/strawberryfields-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `strawberryfields` can be installed with:

```
conda install strawberryfields
```

It is possible to list all of the versions of `strawberryfields` available on your platform with:
